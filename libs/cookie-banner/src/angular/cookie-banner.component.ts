...
import type { CookieBannerAcceptContext, CookieBannerOptions } from '../lib/cookie-banner.js';
import { hasAcceptedCookieBanner, saveAcceptedCookieBanner } from '../lib/cookie-banner.js';

@Component({
  selector: 'lib-cookie-banner',
  template: `
    @if (visible()) {
      <section [class]="bannerClass()" role="banner" [attr.aria-label]="ariaLabel()">
  ...
  `,
  styleUrl: '../lib/cookie-banner.css',
