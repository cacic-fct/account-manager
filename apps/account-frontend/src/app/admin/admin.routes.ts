...
export const adminRoutes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./student-verification/admin-student-verification.component').then(
        (m) => m.AdminStudentVerificationComponent,
      ),
  },
  {
    path: 'discord-integration',
    loadComponent: () =>
      import('./discord-integration/discord-integration.component').then((m) => m.DiscordIntegrationComponent),
  },
  {
    path: 'discord-role-overrides',
    loadComponent: () =>
      import('./discord-managed-role-overrides/discord-managed-role-overrides.component').then(
        (m) => m.DiscordManagedRoleOverridesComponent,
      ),
  },
  {
